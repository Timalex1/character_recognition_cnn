...
image_dataset = load_image_files(
    "C:/Users/Timilehin Vincent/Desktop/Desktop/project/SVM ONLINE RECOGNITION DATASET/training")
...
# joblib.dump(pca, 'train_pca.pkl', 1)
...
# joblib.dump(clf, open("train_rbf_SVM.pkl", "wb"))
