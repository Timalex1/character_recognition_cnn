...
# C: \Users\Timilehin Vincent\Desktop\Desktop\project\imageCopy
path_n = 'C:/Users/Timilehin Vincent/Desktop/Desktop/project/SVM ONLINE RECOGNITION DATASET/test/**/*.bmp'
path_out = 'out'
window_name = 'crop'
size_max_image = 500
debug_mode = True
...
def detect_box(image, cropIt=True):
    ...
    #                                      b  g   r
    cv2.drawContours(image, contours, -2, (51, 51, 51), 3)
...
#     for file_iterator in glob.glob(path_in):
...
#         # Create out path
#         if not os.path.exists(file_iterator):
#             os.makedirs(file_iterator)
